...
import org.apache.tapestry.finder.dal.CayenneCrudServiceDAOImpl;
...
public class AppModule
{
	...
	binder.bind(CayenneCrudServiceDAO.class,
		CayenneCrudServiceDAOImpl.class);
	binder.bind(TapestryVersionService.class,
		TapestryVersionServiceImpl2.class);
	binder.bind(EntryService.class, EntryServiceImpl2.class);
	binder.bind(UserService.class, UserServiceImpl2.class);
	binder.bind(RoleService.class, RoleServiceImpl2.class);
	binder.bind(EntryTypeService.class, EntryTypeServiceImpl2.class);
	binder.bind(SourceTypeService.class, SourceTypeServiceImpl2.class);
	binder.bind(LicenseService.class, LicenseServiceImpl2.class);
    }
     ...
     * initialisation. In most cases, use the static bind() method instead.
     * 
     * <p>
    ...
    /**
     * Contribute to the RequestHandler service configuration. This is how we
     * extend Tapestry using the timing filter. A common use for this kind of
     * filter is transaction management or security. The @Local annotation
     * selects the desired service by type, but only from the same module.
     * Without @Local, there would be an error due to the other service(s) that
	...
	configuration.addInstance(TapestryVersion.class,
		TapestryVersionEncoder.class);
